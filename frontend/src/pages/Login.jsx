  ...
  return (
    <div className="flex justify-center items-center min-h-[70vh]">
      <div className="glass p-10 rounded-3xl w-full max-w-md">
        <h2 className="text-3xl font-extrabold text-center mb-8 bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600">Welcome Back</h2>
        ...
        <p className="text-center mt-6 text-gray-600">
          New customer? <Link to="/register" className="text-indigo-600 font-bold hover:underline">Register here</Link>
        </p>
      </div>
    </div>
  );
